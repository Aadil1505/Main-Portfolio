...
export const ContributionGraphBlock = ({
  ...
  return (
    <rect
      className={cn(
        // GitHub-style green ramp. A deliberate, user-approved exception to the
        // One Blue Rule for this section (like the shader hexes in hero.tsx);
        // theme-aware light/dark so it reads on cream and warm-near-black.
        "stroke-[length:1px] stroke-foreground/[0.06]",
        'data-[level="0"]:fill-[#ebedf0] dark:data-[level="0"]:fill-[#2c2b28]',
...
export const ContributionGraphCalendar = ({
  ...
  return (
    ...
    >
      <svg
        className="block h-auto w-full min-w-[680px] overflow-visible"
        height={height}
