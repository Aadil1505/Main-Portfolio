    ...
    <div className="container py-24 lg:py-32">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid gap-12">
          ...
          <section>
            ...
            <div className="mb-8">
              <div className="flex justify-between mb-2">
                <h3 className="text-xl font-semibold">Disko</h3>
                <span className="text-base sm:text-lg text-muted-foreground">March 2025 - Present</span>
              </div>
              <div className="flex">
                <img className="flex-shrink-0 mt-1 h-5 w-5 text-primary" src='https://disko.tv/wp-content/uploads/2023/03/cropped-disko2023-1-1-32x32.jpg' />
                <div className="ml-4">
                  <h4 className="text-lg font-semibold mb-2">Software Development Intern</h4>
            ...
            <div className="mb-8">
              ...
              <div className="flex">
                <img className="flex-shrink-0 mt-1 h-5 w-5 text-primary" src='https://www.hofstra.edu/themes/contrib/hofstra/assets/img/logo-shield.png' />
                <div className="ml-4">
                  <h4 className="text-lg font-semibold mb-2">MakerSpace Software Developer</h4>
                  <ul className="space-y-2 text-muted-foreground list-disc list-inside">
          ...
          {/* Software Projects */}
          <section>
            <h2 className="text-2xl font-bold lg:text-3xl mb-6">Software Projects</h2>

            {/* SaaStrike */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold mb-2">SaaStrike</h3>
            ...
            {/* Authlink */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold mb-2">Authlink</h3>
              <p className="text-muted-foreground">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-muted-foreground mb-2">Frameworks & Libraries</h4>
                <div className="flex flex-wrap gap-2">
          ...
          <section>
            ...
            <div className="mb-4">
              <h3 className="text-xl font-semibold">Hofstra University</h3>
              <p className="text-muted-foreground">B.S. Computer Science (Dean&apos;s List)</p>
          ...
          {/* Achievements */}
          <section>
            <h2 className="text-2xl font-bold lg:text-3xl mb-6">Achievements</h2>
            <div className="mb-4">
              <div className="flex justify-between mb-2">
                <h3 className="text-xl font-semibold">Amazon-Sponsored Capture the Flag Competition</h3>
                <span className="text-base sm:text-lg text-muted-foreground">November 2025</span>
              </div>
              <p className="text-muted-foreground">
