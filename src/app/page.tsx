...
export default function Home() {
  return (
    <>
      ...
      {/* LANDING HERO */}
      <div className="relative overflow-hidden py-16 sm:py-24 lg:py-32 min-h-screen">
            ...
            <div className="max-w-2xl text-center mx-auto">
              ...
              <div className="mt-4 sm:mt-5 max-w-2xl">
                ...
                <BoxReveal boxColor={"lightblue"} duration={0.5}>
                  <h1 className="scroll-m-20 text-4xl sm:text-5xl font-extrabold tracking-tight lg:text-5xl">
                  Aadil Alli
                  </h1>
                </BoxReveal>
                </div>
      ...
      <div className="min-h-screen flex justify-center items-center">
        <div className="container px-4 sm:px-6 py-16 sm:py-24 lg:py-32">
          <div className="max-w-2xl mx-auto space-y-6 sm:space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold lg:text-4xl">Aadil...</h2>
            <div className="space-y-6 lg:space-y-10">
              {/* Icon Block */}
              <div className="flex">
                <CodeXml className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
              ...
              {/* Icon Block */}
              <div className="flex">
                <Flag className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
                <div className="ms-4 sm:ms-8">
                  <h3 className="text-base sm:text-lg font-semibold">
              ...
              {/* Icon Block */}
              <div className="flex">
                <SquareChartGantt className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
                <div className="ms-4 sm:ms-8">
                  <h3 className="text-base sm:text-lg font-semibold">
      ...
      {/* WORK SECTION */}
      <div id="Work" className="min-h-screen flex items-center justify-center text-center px-4">
        <div className="text-3xl sm:text-4xl font-bold md:p-8 md:text-5xl lg:p-10 lg:text-6xl xl:text-7xl">Some of my<span><WordRotate words={["Work", "Experience", "Projects", "Side quests"]}/></span></div>
      </div>
      ...
      <div id="Resume" className="min-h-screen flex items-center justify-center text-center">
        <VelocityScroll
          text="Resume"
          default_velocity={5}
          className="font-display text-center text-5xl sm:text-6xl font-bold tracking-[-0.02em] drop-shadow-sm md:text-7xl lg:text-8xl md:leading-[5rem] transform-gpu"
        />
      </div>
      <Resume/>
