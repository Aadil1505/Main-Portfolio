      ...
      <div className="container px-4 sm:px-6 py-16 sm:py-24 lg:py-32">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid gap-8 sm:gap-12">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold lg:text-4xl">CS Technician</h2>
            ...
            <div className="space-y-6 lg:space-y-10">
              ...
              <div className="flex">
                ...
                <Mail className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
                <div className="ms-4 sm:ms-8">
                  ...
                  <div className="mt-3 sm:mt-4 flex flex-wrap gap-2 sm:gap-x-4">
                    <Badge variant="outline" className="text-xs sm:text-sm">Rocky Linux</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">AWS</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">Postfix</Badge>
                  </div>
                </div>
              </div>
              {/* End Icon Block */}
              {/* Icon Block */}
              <div className="flex">
                <Lock className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
                <div className="ms-4 sm:ms-8">
                  <h3 className="text-base sm:text-lg font-semibold">
                  ...
                  <div className="mt-3 sm:mt-4 flex flex-wrap gap-2 sm:gap-x-4">
                    <Badge variant="outline" className="text-xs sm:text-sm">Rocky Linux</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">SSH</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">PrivacyIdea</Badge>
                  </div>
                </div>
              </div>
              {/* End Icon Block */}
              {/* Icon Block */}
              <div className="flex">
                <UsersRound className="flex-shrink-0 mt-1 sm:mt-2 h-5 w-5 sm:h-6 sm:w-6" />
                <div className="ms-4 sm:ms-8">
                  <h3 className="text-base sm:text-lg font-semibold">
                  ...
                  <div className="mt-3 sm:mt-4 flex flex-wrap gap-2 sm:gap-x-4">
                    <Badge variant="outline" className="text-xs sm:text-sm">Nodejs</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">Ejs</Badge>
                    <Badge variant="outline" className="text-xs sm:text-sm">Github</Badge>
                  </div>
                </div>
              </div>
              {/* End Icon Block */}
